...
[[ -n "${VOC_BIGQUERY_PROJECT:-}" ]] && PARAM_OVERRIDES="$PARAM_OVERRIDES VocBigqueryProject=$VOC_BIGQUERY_PROJECT"
[[ -n "${VOC_BIGQUERY_TABLE:-}" ]] && PARAM_OVERRIDES="$PARAM_OVERRIDES VocBigqueryTable=$VOC_BIGQUERY_TABLE"
[[ -n "${VOC_BIGQUERY_START_DATE:-}" ]] && PARAM_OVERRIDES="$PARAM_OVERRIDES VocBigqueryStartDate=$VOC_BIGQUERY_START_DATE"
[[ -n "${VOC_BIGQUERY_LOCATION:-}" ]] && PARAM_OVERRIDES="$PARAM_OVERRIDES VocBigqueryLocation=$VOC_BIGQUERY_LOCATION"
[[ -n "${VOC_GOOGLE_CREDENTIALS_SSM_KEY:-}" ]] && PARAM_OVERRIDES="$PARAM_OVERRIDES VocGoogleCredentialsSsmKey=$VOC_GOOGLE_CREDENTIALS_SSM_KEY"
[[ -n "${VOC_SLACK_CHANNEL:-}" ]] && PARAM_OVERRIDES="$PARAM_OVERRIDES VocSlackChannel=$VOC_SLACK_CHANNEL"
[[ -n "${VOC_FORCE_RUN:-}" ]] && PARAM_OVERRIDES="$PARAM_OVERRIDES VocForceRun=$VOC_FORCE_RUN"
